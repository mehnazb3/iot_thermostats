...
RSpec.describe Api::V1::ReadingsController, :type => :controller do
  ...
  #     expect(assigns(:reading)).to be_a_new(Reading)
  #   end
  # end
  ...
  #       post :create, {:reading => valid_attributes}, valid_session
  #       expect(assigns(:reading)).to be_a(Reading)
  #       expect(assigns(:reading)).to be_persisted
  #     end
  ...
  #       post :create, {:reading => invalid_attributes}, valid_session
  #       expect(assigns(:reading)).to be_a_new(Reading)
  #     end
  ...
  #       reading = Reading.create! valid_attributes
  #       put :update, {:id => reading.to_param, :reading => new_attributes}, valid_session
  #       reading.reload
  ...
  #       reading = Reading.create! valid_attributes
  #       put :update, {:id => reading.to_param, :reading => invalid_attributes}, valid_session
  #       expect(assigns(:reading)).to eq(reading)
  #     end
